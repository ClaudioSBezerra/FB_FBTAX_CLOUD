...
func main() {
	...
	http.HandleFunc("/api/health", func(w http.ResponseWriter, r *http.Request) {
		...
		json.NewEncoder(w).Encode(HealthResponse{
			...
			Service:   "FBTAX_CLOUD Portal Hub",
	...
	http.HandleFunc("/api/financeiro/contratos/detalhe",          withAuth(handlers.ContratoDetalheHandler, "admin"))
	http.HandleFunc("/api/financeiro/contratos/pdf",              withAuth(handlers.ContratoPDFHandler, "admin"))
	http.HandleFunc("/api/financeiro/contratos/upload-assinado",  withAuth(handlers.ContratoUploadAssinadoHandler, "admin"))
	http.HandleFunc("/api/financeiro/contratos/download-assinado",withAuth(handlers.ContratoDownloadAssinadoHandler, "admin"))
	http.HandleFunc("/api/financeiro/faixas-preco",               withAuth(handlers.FaixasPrecoHandler, "admin"))
	http.HandleFunc("/api/financeiro/faixas-preco/calcular",   withAuth(handlers.FaixasCalcularHandler, "admin"))
	...
	http.HandleFunc("/api/bancos", withDB(handlers.BancosHandler))
	...
	fmt.Printf("FBTAX_CLOUD starting on port %s...\n", port)
